#!/usr/bin/env tsx
/**
 * Paid-tier database builder for Finnish Law MCP server.
 *
...
function buildPaidTier(): void {
  console.log('Building paid-tier extensions for Finnish Law MCP...\n');
  ...
  console.log(`    2. preparatory_works_full -- needs full-text preparatory works sources (future)`);
