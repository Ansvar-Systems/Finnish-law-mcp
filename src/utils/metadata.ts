...
function getSourceAuthority(): SourceAuthority {
  return {
    primary_source: 'Finlex open data (opendata.finlex.fi Akoma Ntoso) for statutes, with EUR-Lex for EU references',
    authority_level: 'official',
    verification_required: 'ALWAYS cross-check with official Finlex publications and competent authority guidance before using in professional legal work.'
  };
}
